...
class CategoriesScreen extends StatelessWidget {
  ...
  void showCategoryBottomSheet(BuildContext context, {Category? categoryToUpdate}) {
            ...
            children: [
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  ...
                  hintStyle: AppTextStyle.regularBlack16.copyWith(color: const Color(0xffAFAFAF)),
                  filled: true,
              ...
              ElevatedButton(
                onPressed: () {
                  if (categoryController.text.isNotEmpty) {
                    if (categoryToUpdate != null) {
                      noteC.updateCategory(categoryToUpdate, categoryController.text);
                    } else {
                ...
                child: Center(
                  child: Text(
                    categoryToUpdate != null ? "Update Category" : "Add Category",
          ...
          return Card(
            ...
            child: ListTile(
              ...
              trailing: Row(
                ...
                children: [
                  IconButton(
                    icon: const Icon(Icons.edit, color: Color(0xffAFAFAF)),
                    onPressed: () => showCategoryBottomSheet(context, categoryToUpdate: category),
                  ),
                  IconButton(
                    icon: const Icon(Icons.delete, color: Color(0xffAFAFAF)),
                    onPressed: () => confirmDeleteCategory(context, category),
                  ),
                ],
              ),
            ),

        ...
        children: [
          ...
          Expanded(
            child: Obx(() {
              ...
              final groupedCompletedTasks =
                  todoC.getCompletedTasksGroupedByDate();
              ...
              for (var task in filteredCompletedTasks) {
                final normalizedDate = DateTime(task.completedAt!.year,
                    task.completedAt!.month, task.completedAt!.day);
                if (!filteredGroupedCompletedTasks
              ...
              return ListView(
                ...
                children: allDates.map((date) {
                  ...
                  final completedTasksForDate =
                      filteredGroupedCompletedTasks[date] ?? [];
                                                  ...
                                                  style:
                                                      ElevatedButton.styleFrom(
                                                          ...
                                                          minimumSize:
                                                              Size(100, 40),
                                                          elevation:
                                                              0 // Explicitly sets minimum width to 100
                                                          ),
                                                  child: Text('No',
                                                      style: AppTextStyle
                                                          .mediumPrimary14),
                                                ...
                                                ElevatedButton(
                                                  ...
                                                  style:
                                                    ...
                                                    minimumSize: Size(100,
                                                        40), // Explicitly sets minimum width to 100
                                                  ),
                                                  child: Text("Yes",
                                                      style: AppTextStyle
                                                          .mediumBlack14
